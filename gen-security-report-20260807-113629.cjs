...
const fs = require('fs');
const OUTPUT = 'C:\\Users\\Grace\\Desktop\\AI測試好朋友\\輪休表\\排班作業\\security-report-20260807-113629.docx';
...
const doc = new Document({ sections:[{ properties:{ page:{ size:{width:11906,height:16838}, margin:{top:1440,right:1440,bottom:1440,left:1440} } }, children:[
  ...
  body('本次異動：移除儀表板「各廠商到班率」長條圖區塊'),
  spacer(),
  h2('異動說明'),spacer(),
  body('使用者要求移除儀表板中的「各廠商到班率（長期/臨時）」長條圖統計區塊。'),
  body('此為純 JSX UI 元件刪除，移除對應的 <div> 區塊及 Canvas 元件。'),
  body('無資料邏輯、無 API 呼叫、無安全相關程式碼異動。'),
  ...
  body('  ✅  移除各廠商到班率長條圖（純 UI 刪除，無安全影響）'),
]}]});
