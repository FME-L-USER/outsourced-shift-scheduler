...
const fs = require('fs');
const OUTPUT = 'C:\\Users\\Grace\\Desktop\\AI測試好朋友\\輪休表\\排班作業\\security-report-20260804-230058.docx';
...
const doc = new Document({ sections:[{ properties:{ page:{ size:{width:11906,height:16838}, margin:{top:1440,right:1440,bottom:1440,left:1440} } }, children:[
  ...
  body('本次異動：還原各廠商到班率圖表為橫條圖版本（revert 直條圖）'),
  body('  - 使用 Canvas 2D API 橫條圖繪製，純前端計算'),
  body('  - 無新增 API 呼叫或後端異動'),
